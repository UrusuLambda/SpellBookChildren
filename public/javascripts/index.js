...
$(document).ready(function(){
	...
	function preload ()
	{
	    this.load.image('sky', 'http://localhost:3000/sky.png');
	    this.load.image('ground', 'http://localhost:3000/platform.png');
	    this.load.image('star', 'http://localhost:3000/star.png');
	    this.load.image('bomb', 'http://localhost:3000/bomb.png');
	    this.load.spritesheet('dude', 'http://localhost:3000/dude.png', { frameWidth: 32, frameHeight: 48 });
	}
	...
	//-----------------------------------------------
	{
	    ...
	    canvasSpell.setBackgroundImage("http://localhost:3000/notebook.jpeg", canvasSpell.renderAll.bind(canvasSpell), {
